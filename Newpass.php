...
if(isset($_REQUEST['pwdrst']))
{
  ...
  if($pwd == $cpwd)
  {
    $reset_pwd = mysqli_query($conn,"UPDATE userlog set password='$pwd' where email='$email'");
    if($reset_pwd>0)
    {
...
if(isset($_GET['secret']))
{
  ...
  $check_details = mysqli_query($conn,"SELECT email from userlog where email='$email'");
