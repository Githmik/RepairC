...
if(isset($_REQUEST['pwdrst']))
{
  ...
  $check_email = mysqli_query($conn,"SELECT email from userlog where email='$email'");
  ...
  if($res>0)
  {
    $message = '<div>
     ...
     <br>
     <p><button class="btn btn-primary"><a href="http://localhost/Rpc/Newpass.php?secret='.base64_encode($email).'">Reset Password</a></button></p>
     <br>
     <p>If you did not request a password reset, no further action is required.</p>
    </div>';

    
    require 'htdocs/Rpc/PHPMailer/src/Exception.php';
require 'htdocs/Rpc/PHPMailer/src/PHPMailer.php';
require 'htdocs/Rpc/PHPMailer/src/SMTP.php';
