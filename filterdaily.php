...
<h2>Repair Center Management System</h2>
            ...
            <div class="col-md-12">
                <div class="card mt-5">
                    <div class="card-header">
                        <h4>Equipment and Fault Daily Report</h4>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        <table class="table table-borderd">
                            ...
                            <?php  
                                ...
                                if(isset($_GET['category']) && isset($_GET['to_date']) )
                                {
                                    
                                    $to_date = $_GET['to_date'];
                                    $cat = $_GET['category'];

                                    $query = "SELECT serialNo, Fault FROM repaired_units WHERE date='$to_date' AND  Category='$cat' ";
    ...
    if(isset($_POST['filter']))
    {
        ...
        $query = "SELECT COUNT(Fault) AS total FROM  repaired_units where date='$fn' AND  Category='$cn' ";
        $result = $conn->query($query);
