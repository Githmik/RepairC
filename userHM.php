    ...
    <body>
        ...
        <div class="nav">
            ...
            <ul>
                ...
                <li><a href="#">Faults</a>
                  <ul>
                    <li><a href="AddFaults.php">Add Faults</a> </li>
                ...
                <li><a href="#">Products</a>
                    <ul>
                        <li><a href="ManageProd.php">Add Product</a> </li>
                        
                        <li><a href="SearchProd.php">Search Product</a> </li>

                        <li><a href="ChekIn.php">Check In Product</a> </li>
                        
                        <li><a href="checkOut.php">Check Out Product</a> </li>
