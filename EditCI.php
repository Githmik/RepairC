...
$sql ="SELECT * from check_in where id=$id";
...
if(isset($_POST['edit'])){
    ...
    $sql = "UPDATE check_in SET date='".$date."', CategoryId='".$ca."', qty='".$qty."' WHERE id='".$id."'";
    $result=mysqli_query($conn,$sql);
    ...
    if($result){
      ...
      $_SESSION['message'] = "Check In Updated Successfully";
        header('location:ViewCI.php?updated');
        exit(0);
...
<html lang="en">
<head>
  <title>Edit Check In Items </title>
  <meta charset="utf-8">
